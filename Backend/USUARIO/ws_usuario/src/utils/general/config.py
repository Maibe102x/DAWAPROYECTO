...
print(f"User: {Parametros.db_user}")
print(f"Password: {Parametros.db_pass}")
print(f"Host: {Parametros.db_host}")
print(f"Port: {Parametros.db_port}")
print(f"Database: {Parametros.db_name}")
